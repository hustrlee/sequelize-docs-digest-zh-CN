...
由于精力、能力有限，本项目是 [Sequelize master Docs](https://sequelize.org/master/index.html) 的中文摘要，并不是 word-for-word 的翻译。在保留原文档结构和主要内容的情况下，只保留了与 MySQL 相关的内容，并把一些例子改写成 MySQL 版本，对一些扩展内容进行了删减。
...
[Model 基础 (Model Basic)](./model-basic.md)
